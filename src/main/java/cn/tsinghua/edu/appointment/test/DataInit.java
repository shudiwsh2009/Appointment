...
public class DataInit {
	...
	public static void main(String[] args) throws ParseException {
		...
		Appointment app1 = new Appointment(
				DateUtil.convertDate("2015-04-24 08:00"),
				DateUtil.convertDate("2015-04-24 09:00"), "李老师");
		Appointment app2 = new Appointment(
				DateUtil.convertDate("2015-04-24 09:00"),
				DateUtil.convertDate("2015-04-24 10:00"), "李老师");
